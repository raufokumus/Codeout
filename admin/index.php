...
<head>
    ...
    <meta name="description" content="Codeout sitesi admin paneli">
    <meta name="author" content="Rauf Okumuş">
    <link rel="shortcut icon" href="../icon.svg">
    <title>Codeout | Admin - Dashboard</title>
...
<body id="page-top">
    ...
    <a class="scroll-to-top bg- rounded" href="#page-top">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Çıkış yaptıktan sonra admin paneline tekrar şifre ile giriş yapılması gerekmektedir.</div>
