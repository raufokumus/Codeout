...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 ml-3">Video Kaldır</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?sayfa=dersler">Dersler</a></li>
              <li class="breadcrumb-item active">video kaldır</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="col-md-6 float-left">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="../yonlendir.php?sayfa=v_sil&id=<?php echo $id;?>&video=<?php echo $video;?>" method="post">
                ...
                <div class="card-footer text-center">
                  <button type="submit" class="btn btn-primary col-2 swalDefaultSuccess">Video Kaldır</button>
                </div>
              </form>
